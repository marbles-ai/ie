...
class CcgTypeMapper(object):
    ...
    try:
        ...
        _MODEL.add_template(r'((N_1\N_1)/S[dcl])\((N_1\N_1)/NP)')
        ...
        _MODEL.add_unary_rule(r'((S[X]_1\NP_2)/NP_3)\((S[X]_1\NP_2)/NP_3)', '(S[X]_1\NP_2)/NP_3')
        ...
        _MODEL.add_unary_rule(r'(S[pss]_1\NP_1)\(S[pss]_1\NP_2)', 'S_1\NP_2')
        _MODEL.add_unary_rule(r'(S[dcl]_1\NP_2)\(S[dcl]_1\NP_2)', 'S_1\NP_2')
        _MODEL.add_unary_rule(r'(S[em]_1\NP_2)\(S[em]_1\NP_2)', 'S_1\NP_2')
        _MODEL.add_unary_rule(r'(S_1\NP_2)\(S_1\NP_2)', 'S[ng]_1\NP_2')
        _MODEL.add_unary_rule(r'(S[X]_1\NP_2)\(S[X]_1\NP_2)', 'S_1\NP_2')
        ...
        _MODEL.add_unary_rule(r'NP_1', r'S[ng]_1\NP_2')
